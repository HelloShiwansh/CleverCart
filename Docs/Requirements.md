...
As an **AI/ML Engineer**, the objective is to design and implement a clustering-based system that can uncover hidden patterns in customer behaviour and support **data-driven decision-making** for personalized marketing and improved customer retention.
...
- Visualize clusters and interpret customer behaviour patterns
